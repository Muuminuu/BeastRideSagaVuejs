...
import { AnimalType, DamageType, EnemyType, TargetType } from '@/core/types/Enums';
  ...
  setup() {
    ...
    const startCombat = () => {
      ...
      spirit.abilities.push({
        ...
        damageType: DamageType.Dark, // Utiliser une valeur de l'énumération DamageType
        power: 25,
        cooldown: 2,
        currentCooldown: 0,
        targetType: TargetType.SingleEnemy // Utiliser une valeur de l'énumération TargetType
      });
      ...
      enemy.abilities.push({
        ...
        damageType: DamageType.Physical, // Utiliser une valeur de l'énumération DamageType
        power: 15,
        cooldown: 1,
        currentCooldown: 0,
        targetType: TargetType.SingleEnemy // Utiliser une valeur de l'énumération TargetType
